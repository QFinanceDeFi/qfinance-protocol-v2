...
contract InterestRateModel {
     ...
     */
    uint256 internal constant MIN_ROOF_VALUE = 1e18;
    ...
    function updateTripleRateModelInternal(
        ...
        require(kink1_ <= kink2_, "kink1 not <= kink2");
        require(roof_ >= MIN_ROOF_VALUE, "invalid roof");

        baseRatePerBlock = baseRatePerYear.div(BLOCKS_PER_YEAR);
        multiplierPerBlock = (multiplierPerYear.mul(1e18)).div(BLOCKS_PER_YEAR.mul(kink1_));
