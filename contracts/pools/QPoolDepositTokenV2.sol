...
abstract contract QPoolDepositTokenV2 is Context {
    ...
    mapping (address => uint256) internal _balances; // Standard ERC20 balances
    mapping (address => mapping (address => uint256)) internal _allowances; // Standard ERC20 allowances
    ...
    **/ 
     ...
     */
    function transfer(address _recipient, uint256 _amount) external virtual returns (bool) {
